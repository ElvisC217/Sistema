...
$sql_fetch_clientes = "SELECT * FROM proveedor";
...
<body>
  ...
  <header class="header">
    ...
    <div class="table-product">
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="fixclientes.php ?id=<?php echo $row['id'] ?>&message=<?php echo $row['Nombre'] ?>&Correo=<?php echo $row['Correo'] ?>&Numero=<?php echo $row['Numero']; ?> " role="button">
                                Editar  </a></td>
                        <td class="delete"><a name="id" id="" class="bdelete" href="deletep.php?id=<?php echo $row['id'] ?>" role="button">
                                Eliminar  </a></td>
                    </tr>
                <?php
                    $idpro++;
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="addprove1.php" role="button">Agregar Proveedor</a>
    </div>
    <?php
    mysqli_close($conn);
    ?>
