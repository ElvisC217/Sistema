...
$sql_fetch_clientes = "SELECT * FROM Clientes ORDER BY id ASC";
...
<header class="header">
    ...
    <div class="table-product">
        ...
        <div class="addclientes">
            <form method="POST" action="addclientes.php">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="modify" style="float:right">Agregar Cliente</button>
